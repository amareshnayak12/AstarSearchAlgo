...
public class AStarLogic {
   ...
   public static boolean closed[][]=new boolean[InputFileReader.lineCount][InputFileReader.lineCount];
   
   public static Coordinates srcCoord=null;
   public static Coordinates destCoord=null;
   ...
   public static void setBlocked(int i, int j){
    ...
    public static  void AStar(int grid[][], Map <String,Coordinates> srcMap, Map <String,Coordinates> destMap,Integer ROW, Integer COL){ 
